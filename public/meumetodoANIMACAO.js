 ...
 // Seleciona todos os elementos com a classe 'cartao-info'
  ...
  const elementosParaAnimar2 = document.querySelectorAll('.chamada-para-acao__conteudo');

  

  // Adiciona a classe 'oculto' a todos os elementos para que eles comecem invisíveis
  elementosParaAnimar2.forEach(elemento => {
    elemento.classList.add('oculto');
  });
  ...
  const observer2 = new IntersectionObserver((entries) => {
    ...
    threshold: 1 // Aciona o evento quando 50% do elemento está visível
  });
